             		 ...
             		 $.ajax({ 
             			 ...
             			 data : { 
  							...
  							$.each(data, function(index, entry){
  									...
  									table +="<td width='260px' valign='top'><div style='font-size: 25px; font-style:inherit; '>"+entry.hotelNm+"</div><br>"+entry.hotelAddress+" <br>☎"+entry.hotelTel+" <br><a href='#' style='color: black''>"+entry.hotelHomepage+"</a></td>";
  									
  								    table += " <td width='210px' style='font-size: 20px'>  <div class='wrap-star' ><table><tr><td><div class='star-rating'><span style ='width:"+entry.evlAvg*20+"%'></span></div></td>";
  								    table += "<td style='font-size: 15px'>"+entry.evlAvg+"</td></tr></table></div></td>";
  									
  								    table +="<td  align='center' width='150px'>￦49,999</td>";
  									table +="<td align='center' width=:'100px'><a href='roomListMbr?hotelNo="+entry.hotelNo+"&CHECKIN="+checkin+"&CHECKOUT="+checkout+"&DATE="+date+"'><div style='color:black'><input type='button' value='예약' style='width: 100px; background: rgb(76, 117, 177);color:white; border-radius:20px' /></div></a></td>";
  									table +="</tr>";
  								   	table +="</table><br>";
...
<br><br>
    ...
    <table border="1" style="width: 1050px ; height:200px; border-style: groove ;border-color:rgb(149, 165, 166); border-top-color:rgb(76, 117, 177);border-top-width: 10px; border-left:none ; border-radius: 30px " >
  
    <tr>
    <td width="280" ><img src="<c:url value="/resources/img/${list.hotelPhoto}"/>" height="200px" width="300px"/></td>
    <td width="260px" valign="top"><br><div style="font-size: 25px; font-style:inherit; "> ${list.hotelNm }</div> <br>${list.hotelAddress} <br>☎${list.hotelTel } <br><a href="#" style="color: black">🏠${list.hotelHomepage }</a></td>
    <td   style="font-size: 20px">
     ...
     <div class="wrap-star" >
					...
					<td style="font-size: 20px">&nbsp;&nbsp;${list.evlAvg}</td></tr></table>
    ...
    <input style="width: 100px; background: rgb(76, 117, 177);color:white; border-radius:20px " type="button" value="예약" onclick="location='roomListMbr?hotelNo=${list.hotelNo}&CHECKIN=${CHECKIN}&CHECKOUT=${CHECKOUT}&DATE=${DATE}'"/>
    </td>
	</tr>
    </table>
 ...
 <!--     <div id="show"></div> -->
    <input type="button" class="next" value="더보기" style="  background: rgb(76, 117, 177);color:white; border-radius:20px ">
 <div id="show"></div>
    </div>

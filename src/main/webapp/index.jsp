                            ...
                            <div class="col-xl-12">
                                ...
                                <form action="hotelListMbr?PAGENO=1" class="search-box">
                                    <div class="input-form mb-30">
                                        <input type="text"  name="value" placeholder="When Would you like to go ?">
                                    </div>
                                  <div  >                                    
                                         <input id ="date" type="text" name="DATE" class="selector" value="" placeholder="체크인/체크아웃" />
                                         <script>
                                     	$(".selector").flatpickr({ 
                ...
                <div class="row">
    				...
    				<div class="col-xl-3 col-lg-4 col-md-6" >
                        <div class="single-place mb-30">
                            <div class="place-img">
                      <a href="roomListMbr?hotelNo=${list.hotelNo }&PAGENO=1"> 
                            <img src="<c:url value="/resources/img/${list.hotelPhoto}"/>" style=" width:250px; height: 250px"/>
                            </a>
                            </div>
                            <div class="place-cap">
                                <div class="place-cap-top">
                                    <span><i class="fas fa-star"></i><span>8.0 Superb</span> </span>
                                    <h3><a href="roomListMbr?hotelNo=${list.hotelNo }&PAGENO=1">${list.hotelNm }</a></h3>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-tittle text-center">
                            <span style="font-size: 25px; margin-right: 60px" >이 도시는 어때요?</span>
                ...
                <div class="row">
    				<table>
    					<tr align="center">
    						<td>
    							 <a href="hotelListMbr?value=서울&PAGENO=1"><img width="200" src="img/서울.jpg" ></a>
    							 <div align="center" style="font-size: 35px">서울</div>
    						</td>
    						<td style="width: 100px"><td>
    						<td>
    							<a href="hotelListMbr?value=부산&PAGENO=1"><img width="200" src="img/부산.jpg"></a>
    							<div align="center" style="font-size: 35px">부산</div>
    						</td>
    						<td style="width: 100px"><td>
    						<td>
    							<a href="hotelListMbr?value=제주&PAGENO=1"><img width="200" src="img/제주.jpg"></a>
    							<div align="center" style="font-size: 35px">제주</div>
    						</td>
    						<td style="width: 100px"><td>
    						<td>
    							<a href="hotelListMbr?value=강원&PAGENO=1"><img width="200" src="img/강원.jpg"></a>
    							<div align="center" style="font-size: 35px">강원</div>
    						</td>
    					</tr>
